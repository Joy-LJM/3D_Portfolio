  ...
  const observer = new IntersectionObserver(
    ([entry]) => {
      if (entry.isIntersecting) {
        visible.value = true
        setTimeout(() => { animated.value = true }, 450)
      }
    },
    { threshold: 0.18 }
  )
          ...
          >
            ...
            <div class="skill-rows">
              ...
              >
                ...
                <div class="skill-track" role="progressbar" :aria-valuenow="s.level" aria-valuemin="0" aria-valuemax="100">
                  <div
                    class="skill-fill"
...
.skill-pct small { font-size: 10px; }
